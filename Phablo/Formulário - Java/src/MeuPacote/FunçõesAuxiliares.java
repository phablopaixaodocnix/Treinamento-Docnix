  ...
  public static Formulario preencherFormularioERetornalo(Scanner scanner){
	...
	public static void manipularATabela(ArrayList<Formulario> formularios ,Scanner scanner){
		if(!podeExcluirDaTabela(formularios)){
			...
			do{
				...
				System.out.println("  O que deseja fazer?  (1) Excluir formulario da tabela  (2) Editar formulario  (3) Mostrar todos os dados de um formulário  (4) Voltar ao menu anterior  ");
	...
	private static void edirtarFormularioDaTabela(ArrayList<Formulario> formularios,Scanner scanner){
			...
			do{
				...
				formularioASerEditado = scanner.nextInt(); scanner.nextLine();
			...
			do{
				...
				case 4:
					do{
						...
						System.out.println("   Informe a opção desejada: ");
						opçãoEndereço = scanner.nextInt(); scanner.nextLine();
				...
				case 5:
					...
					do{
						...
						opçãoContatos = scanner.nextInt(); scanner.nextLine();
